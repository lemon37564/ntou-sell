...
<html>
	<H1>後端API</H1>
	<H4>
	<a href=user/login?account=1234&password=1234>測試用帳密:account=1234&password=1234</a>
	<br>
	...
	<p> 
		...
		<a href=user/login?account=test@gmail.com&password=0000>
	...
	<p>
		...
		<a href=user/regist?account=test2@gmail.com&password=1234&name=Wilson>
	...
	<p>
		...
		<a href=user/delete?account=test3@gmail.com&password=1234>
	...
	<p>
		...
		e.g.顯示最新商品(3筆資料)<br>
		<a href=product/newest?amount=3>
	...
	<p>
		...
		<a href=product/search?name=ifone>
	...
	<p>
		...
		<a href=product/filterSearch?name=ifone&minprice=10&maxprice=5000000&eval=0>
	...
	<p> 
		...
		列出歷史紀錄(僅限開發期間)<br>
		<a href=/history/all> /backend/history/all </a><br><br>
	</p>
	<p> 
		backend/history/add?pdid=...<br>
		增加一筆新的歷史紀錄<br>
		e.g.新增目前登入帳號之商品id為1的歷史紀錄<br>
		<a href=history/add?pdid=1>
	...
	<p>
		...
		<a href=order/add?pdid=2&amount=2>
	...
	<p>
		...
		更新競標資訊<br>
		e.g.買家競標了商品<br>
		<a href=bid/set?pdid=6&money=1000>
	...
	<p>
		...
		<a href=cart/add?pdid=2&amount=3>
	...
	<p>
		...
		在購物車更改數量<br>
		e.g.<br>
		<a href=cart/modf?pdid=2&amount=4>
	...
	<p>
		...
		販賣商品<br>
		e.g.在販賣網頁販賣商品<br>
		<a href=sell/set?pdname="火箭"&price=50&description="這是火箭"&amount=3&account="test@gmail.com"&sellerID=2&bid="true"&date="1229"&dateLine="1231">
	...
	<p>
		...
		新增聊天紀錄<br>
		e.g.新增聊天紀錄<br>
		<a href=message/add?receiverUID=1&text="你好">
	...
	<p>
		...
		<a href=message/get?receiverUID=2>
